...
const createElm = (e, t, o, n) => {
 ...
 const n = t.$elm$ = e.$elm$, s = e.$children$, l = t.$children$, r = t.$text$;
 let i;
 null !== r ? (i = n["s-cr"]) ? i.parentNode.textContent = r : e.$text$ !== r && (n.data = r) : ((updateElement(e, t)), null !== s && null !== l ? ((e, t, o, n, s = !1) => {
...
class MyComponent {
    ...
    render() {
        return hAsync("div", { key: '91633c09c4fe7816ffb30497562449575b9e64fb' }, "Hello, World! I'm ", this.getText(), " ", uuid);
    }
